# Cursor Adapter Privacy

Use AKBP for concise, cited, durable project knowledge. Do not use it as a raw transcript dump or private editor cache.

## Do store

- Project decisions with evidence.
- Stable workspace-specific workflow preferences.
...
- Raw terminal logs that may contain credentials.
