# Git-Native Agent Adapter Template

This adapter template shows how a git-native coding agent can use AKBP without inventing a private memory format.

Use it when an agent stores runtime state in a repository, can read project instructions, run local commands, or communicate with the AKBP JSONL tool server.
