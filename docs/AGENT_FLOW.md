...
```json
{"id":"1","method":"akbp.ingest","path":"./my-kb","params":{"file":"notes.md","claim":"Database migrations ship in small verified batches.","claim_type":"decision"}}
{"id":"2","method":"akbp.index","path":"./my-kb","params":{"incremental":true}}
{"id":"3","method":"akbp.search","path":"./my-kb","params":{"query":"database migrations rollback","limit":5}}
{"id":"4","method":"akbp.context","path":"./my-kb","params":{"task":"prepare the next migration release","limit":5}}
```
