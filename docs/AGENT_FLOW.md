...
- Before applying imports, confirm `accepted_count`, `rejected_count`, `error_count`, `review.claims_without_evidence`, `review.claims_without_source_evidence`, `would_write.sources`, and `would_write.claims`.
