...
- `tool-methods.schema.json`: method-specific parameter schemas for query, context, index, search, remember, source add, ingest, import check, supersede, and contradict.
