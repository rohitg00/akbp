...
- `#/$defs/import_check_result`: a closed `akbp.import_check` result with checked, accepted, rejected, and error counts plus accepted object ids, rejected object ids, and parse errors without raw secret echo.
