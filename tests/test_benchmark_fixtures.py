...
class BenchmarkFixtureTest(unittest.TestCase):
    ...
    def test_invalid_param_rejection_fixture_covers_param_error_shapes(self):
        ...
        self.assertIn("zero-param method unknown", fixture_readme)
        self.assertIn("missing required method params", fixture_readme)
        self.assertIn("source verification id", fixture_readme)
        self.assertIn("cite claim id", fixture_readme)
        self.assertIn("claim relation id", fixture_readme)
        self.assertIn("boolean flag", fixture_readme)
        ...
        self.assertEqual(requests["status-unknown-param"]["method"], "akbp.status")
        self.assertEqual(requests["export-unknown-param"]["method"], "akbp.export")
        self.assertEqual(requests["status-unknown-param"]["expected_error_values"]["unknown"], ["surprise"])
        self.assertEqual(requests["export-unknown-param"]["expected_error_values"]["unknown"], ["surprise"])
        self.assertEqual(requests["index-incremental-type-error"]["method"], "akbp.index")
        self.assertEqual(requests["export-check-fail-on-issues-type-error"]["method"], "akbp.export_check")
        self.assertEqual(requests["import-check-fail-on-rejected-type-error"]["method"], "akbp.import_check")
        self.assertEqual(requests["source-verify-fail-on-issue-type-error"]["method"], "akbp.source.verify")
        self.assertIn("incremental must be a boolean", requests["index-incremental-type-error"]["expected_error_contains"]["type_errors[]"])
        self.assertIn("fail_on_issues must be a boolean", requests["export-check-fail-on-issues-type-error"]["expected_error_contains"]["type_errors[]"])
        self.assertIn("fail_on_rejected must be a boolean", requests["import-check-fail-on-rejected-type-error"]["expected_error_contains"]["type_errors[]"])
        self.assertIn("fail_on_issue must be a boolean", requests["source-verify-fail-on-issue-type-error"]["expected_error_contains"]["type_errors[]"])
        ...
        self.assertEqual(requests["query-missing-param"]["expected_error_values"]["missing"], ["query"])
        self.assertEqual(requests["context-missing-param"]["expected_error_values"]["missing"], ["task"])
        self.assertEqual(requests["cite-missing-param"]["expected_error_values"]["missing"], ["claim_id"])
        self.assertEqual(requests["export-check-missing-param"]["expected_error_values"]["missing"], ["file"])
        self.assertEqual(requests["import-check-missing-param"]["expected_error_values"]["missing"], ["file"])
        self.assertEqual(requests["import-apply-missing-param"]["expected_error_values"]["missing"], ["file"])
        self.assertEqual(requests["source-verify-missing-param"]["expected_error_values"]["missing"], ["source_id"])
        self.assertEqual(requests["remember-missing-param"]["expected_error_values"]["missing"], ["text"])
        ...
        self.assertEqual(requests["query-limit-type-error"]["method"], "akbp.query")
        self.assertEqual(requests["context-limit-range-error"]["method"], "akbp.context")
        self.assertIn("limit must be an integer", requests["query-limit-type-error"]["expected_error_contains"]["type_errors[]"])
        self.assertIn("limit must be between 1 and 100", requests["context-limit-range-error"]["expected_error_contains"]["type_errors[]"])
        ...
        self.assertEqual(requests["cite-claim-id-too-long"]["method"], "akbp.cite")
        self.assertEqual(requests["cite-claim-id-control-char"]["method"], "akbp.cite")
        self.assertIn("claim_id must be at most 512 characters", requests["cite-claim-id-too-long"]["expected_error_contains"]["type_errors[]"])
        self.assertIn("claim_id must not contain control characters", requests["cite-claim-id-control-char"]["expected_error_contains"]["type_errors[]"])
        ...
        self.assertEqual(requests["conformance-level-enum-error"]["method"], "akbp.conformance")
        self.assertIn("level must be one of: 0, 1, 2, 3", requests["conformance-level-enum-error"]["expected_error_contains"]["type_errors[]"])
    ...
    def test_search_query_compatibility_fixture_covers_empty_fts_queries(self):
        ...
        dotted = requests["dotted-method-search"]
        self.assertEqual(dotted["expected_result_values"]["fts_query"], '"akbp.session.start" AND "JSONL"')
        self.assertEqual(dotted["expected_result_contains"]["results[].id"], ["claim_search_query_compat"])
